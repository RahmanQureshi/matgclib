...
struct GDataRecord1802
{
	...
	/*70-71*/	UW	axis_b_status; //!<B axis status.
	/*72*/	    UB	axis_b_switches; //!<B axis switches.
	/*73*/	    UB	axis_b_stop_code; //!<B axis stop code.
	/*74-77*/	SL	axis_b_reference_position; //!<B axis reference position.
	/*78-81*/	SL	axis_b_motor_position; //!<B axis motor position.
	/*82-85*/	SL	axis_b_position_error; //!<B axis position error.
	/*86-89*/	SL	axis_b_aux_position; //!<B axis auxiliary position.
	/*90-93*/	SL	axis_b_velocity; //!<B axis velocity.
	/*94-95*/	SW	axis_b_torque; //!<B axis torque.
	...
	/*122-123*/	UW	axis_d_status; //!<D axis status.
	/*124*/	    UB	axis_d_switches; //!<D axis switches.
	/*125*/  	UB	axis_d_stop_code; //!<D axis stop code.
	/*126-129*/	SL	axis_d_reference_position; //!<D axis reference position.
	/*130-133*/	SL	axis_d_motor_position; //!<D axis motor position.
	/*134-137*/	SL	axis_d_position_error; //!<D axis position error.
	/*138-141*/	SL	axis_d_aux_position; //!<D axis auxiliary position.
	/*142-145*/	SL	axis_d_velocity; //!<D axis velocity.
	/*146-147*/	SW	axis_d_torque; //!<D axis torque.

	/*148-149*/	UW	axis_e_status; //!<E axis status.
	/*150*/	    UB	axis_e_switches; //!<E axis switches.
	/*151*/	    UB	axis_e_stop_code; //!<E axis stop code.
	/*152-155*/	SL	axis_e_reference_position; //!<E axis reference position.
	/*156-159*/	SL	axis_e_motor_position; //!<E axis motor position.
	/*160-163*/	SL	axis_e_position_error; //!<E axis position error.
	/*164-167*/	SL	axis_e_aux_position; //!<E axis auxiliary position.
	/*168-171*/	SL	axis_e_velocity; //!<E axis velocity.
	/*172-173*/	SW	axis_e_torque; //!<E axis torque.

	/*174-175*/	UW	axis_f_status; //!<F axis status.
	/*176*/	    UB	axis_f_switches; //!<F axis switches.
	/*177*/	    UB	axis_f_stop_code; //!<F axis stop code.
	/*178-181*/	SL	axis_f_reference_position; //!<F axis reference position.
	/*182-185*/	SL	axis_f_motor_position; //!<F axis motor position.
	/*186-189*/	SL	axis_f_position_error; //!<F axis position error.
	/*190-193*/	SL	axis_f_aux_position; //!<F axis auxiliary position.
	/*194-197*/	SL	axis_f_velocity; //!<F axis velocity.
	/*198-199*/	SW	axis_f_torque; //!<F axis torque.

	/*200-201*/	UW	axis_g_status; //!<G axis status.
	/*202*/  	UB	axis_g_switches; //!<G axis switches.
	/*203*/ 	UB	axis_g_stop_code; //!<G axis stop code.
	/*204-207*/	SL	axis_g_reference_position; //!<G axis reference position.
	/*208-211*/	SL	axis_g_motor_position; //!<G axis motor position.
	/*212-215*/	SL	axis_g_position_error; //!<G axis position error.
	/*216-219*/	SL	axis_g_aux_position; //!<G axis auxiliary position.
	/*220-223*/	SL	axis_g_velocity; //!<G axis velocity.
	/*224-225*/	SW	axis_g_torque; //!<G axis torque.

	/*226-227*/	UW	axis_h_status; //!<H axis status.
	/*228*/  	UB	axis_h_switches; //!<H axis switches.
	/*229*/	    UB	axis_h_stop_code; //!<H axis stop code.
	/*230-233*/	SL	axis_h_reference_position; //!<H axis reference position.
	/*234-237*/	SL	axis_h_motor_position; //!<H axis motor position.
	/*238-241*/	SL	axis_h_position_error; //!<H axis position error.
	/*242-245*/	SL	axis_h_aux_position; //!<H axis auxiliary position.
	/*246-249*/	SL	axis_h_velocity; //!<H axis velocity.
	/*250-251*/	SW	axis_h_torque; //!<H axis torque.
}; //DataRecord1802
